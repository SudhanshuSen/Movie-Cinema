...
@app.route('/recommendation',methods = ['GET', 'POST']) # type: ignore
def recommendation():
    ...
    if request.method == "POST":
        ...
        return render_template("recommendation.html", movie_list = movie_list, status = status, movies_name = "Name", poster = "")           
